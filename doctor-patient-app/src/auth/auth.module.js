...
var doctor_entity_1 = require("../users/doctor.entity");
var jwt_1 = require("@nestjs/jwt");
var jwt_strategy_1 = require("./jwt.strategy");
var jwt_refresh_strategy_1 = require("./jwt.refresh.strategy");
var AuthModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [typeorm_1.TypeOrmModule.forFeature([doctor_entity_1.Doctor]), jwt_1.JwtModule.register({})],
